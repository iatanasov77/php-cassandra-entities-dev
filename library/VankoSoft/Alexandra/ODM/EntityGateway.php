...
use Enigma\Library\Database\Alexandra\ResultSet\ExtractorResultSet;
...
class EntityGateway implements EntityGatewayInterface
{
	...
	/**
	 * @copydoc \VankoSoft\Alexandra\ODM\EntityGatewayInterface::load()
	 */
	...
	/**
	 * @copydoc \VankoSoft\Alexandra\ODM\EntityGatewayInterface::persist()
	 */
