...
class EntityMetaDataConfig implements EntityMetaDataConfigInterface
{
	/**
	 *
	 * @var \Enigma\Library\Config\ConfigLoaderInterface $config
	 */
	protected $config;
	 ...
	 * 
	 * @param	\Enigma\Library\Config\ConfigLoaderInterface $config
	 * 
	 * @return	void
	 */
	public function __construct( ConfigLoaderInterface $config )
	{
		$this->config	= $config;
	}
